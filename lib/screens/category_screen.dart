          ...
          children: [
            ...
            FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  final CategoryScreenResponse categoryScreen = snapshot.data!;
                  return Expanded(
                    child: ListView.separated(
                        itemBuilder: (context, index) {
                              final String movieId = "${categoryScreen.results![index].id}";
                          final Results movie = categoryScreen.results![index];
